...
dia_del_anio = int(input ("Ingrese el numero de día del año: "))
dia_que_corresponde= int(dia_del_anio % 7)
print(dia_que_corresponde)
...
nota_a_letra= int(input("ingrese numero: "))
if nota_a_letra >=90:
  print ("A")
elif nota_a_letra >=80 :
  print ("B")
elif nota_a_letra >=70:
  print("C")
elif nota_a_letra >=60:
  print ("D")
else:
  print("F")
...
def chequear_usuario(usuario, contraseña):
    return usuario == "Juan" and contraseña == "12345_" or usuario == "Pablo" and contraseña == "xDcFvGbHn"
print(chequear_usuario(input("ingrese usuario: "), input("ingrese contraseña: ")))
...
def conjeturaLothar(numero):
    ...
    while numero > 1:
        if numero % 2 == 0:
           ...
           pasos = pasos + 1
    return pasos
print(conjeturaLothar(int(input("número: "))))
...
def promedioTresNotas(notaUno, notaDos, notaTres):
...
def promedioConImportancia (notaUno, notaDos,notaTres):
    promedio= ((notaUno*0.2)+(notaDos*0.5)+(notaTres*0.3))/(0.2+0.3+0.5)
    return promedio


def aprobadoTresNotas (notaUno,notaDos,notaTres):
    return promedioTresNotas(notaUno,notaDos,notaTres)>=4

def aprobadoconImportancia (notaUno,notaDos,notaTres):
    return promedioConImportancia(notaUno, notaDos,notaTres) >= 4

print (aprobadoTresNotas(4,5,5))
print (aprobadoTresNotas(7,5,5))
print (aprobadoTresNotas(2,9,1))
print (aprobadoconImportancia(10,10,5))
print (aprobadoconImportancia(2,9,5))
print (aprobadoconImportancia(1,3,5))
